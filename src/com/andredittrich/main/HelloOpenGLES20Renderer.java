...
//	        "varying vec4 v_Color;      \n" +		
	        "void main(){              \n" +
	        " gl_FragColor =  vec4 (0.11, 0.29, 0.83, 1.0); \n" +
	        "}                         \n";
...
//			GLES20.glDrawElements(GLES20.GL_LINE_STRIP, layer.getIndexBuffer().capacity(),
//					GLES20.GL_UNSIGNED_SHORT, layer.getIndexBuffer());
...
//		}
    ...
    public void onSurfaceChanged(GL10 unused, int width, int height) {
        ...
        Matrix.setLookAtM(mVMatrix, 0, 0, 0, -15f, 0f, 0f, 0f, 0f, 1.0f, 0.0f);
    }
